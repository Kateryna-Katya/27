...
<body>
    ...
    <section class="pages">
        <div class="container">
            ...
            <h1 class="section-title">Политика <span class="text-gradient">файлов cookie</span></h1>
            ...
            <div class="legal-content">
                ...
                <p>
                    Файл cookie — это небольшой текстовый файл, который платформа 
                    <strong><?= $domainTitle ?></strong> сохраняет на вашем устройстве. Это позволяет нам 
                    "помнить" ваши настройки и обеспечивать стабильную работу AI-инструментов обучения.
                </p>

                <h2>Типы файлов cookie</h2>
                <ul class="legal-list">
                    <li>
                        <strong>Строго необходимые:</strong> Обеспечивают безопасность и базовый функционал <strong><?= $domainTitle ?></strong>.
                    </li>
                    <li>
                        <strong>Аналитические:</strong> Помогают нам понять, какие части курса наиболее популярны у студентов в Англии.
                    </li>
                    <li>
                        <strong>Функциональные:</strong> Запоминают ваш прогресс в обучении и предпочтения интерфейса.
                    </li>
                </ul>

                <h2>Зачем мы их используем?</h2>
                <ul class="legal-list">
                    <li>Обеспечение передовой цифровой инфраструктуры.</li>
                    <li>Анализ методологий обучения для их улучшения.</li>
                    <li>Персонализация контента для пользователей в Великобритании и ЕС.</li>
                </ul>
                ...
                <div class="contact-info-block">
                    ...
                    <ul class="contact-data">
                        ...
                        <li><strong>Телефон:</strong> <a href="tel:+442077271897">+44 20 7727 1897</a></li>
                        <li><strong>Адрес:</strong> 18 Notting Hill Gate, London, UK</li>
                    </ul>
                </div>
            </div>
        </div>
