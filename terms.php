            ...
            <div class="legal-content">
                <div class="policy-hero-card terms-accent">
                    <p>
                        ...
                        представляют собой юридически обязывающий договор между вами (далее — «Пользователь») и платформой.
                ...
                <div class="legal-section">
                    ...
                    <p>
                        ...
                        инновационным материалам, статьям в блоге и AI-инструментам развития. Настоящее Соглашение регулирует все аспекты взаимодействия Пользователя с платформой.
                    </p>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <ul class="legal-list">
                        ...
                        <li>Предпринимать действия, которые могут нарушить работу цифровой инфраструктуры школы.</li>
                        <li>Использовать автоматизированные скрипты для сбора информации без нашего разрешения.</li>
                        <li>Предоставлять недостоверную информацию при регистрации на обучение.</li>
                    </ul>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <p>
                        Мы оставляем за собой право изменять Условия в любое время. Все споры будут разрешаться путем конструктивных переговоров согласно действующему законодательству.
                    </p>
                </div>
